...
namespace Elements20Sample
{
    public class Function
    {
        ...
        private IModelStore<Elements20SampleInputs> store;

        public async Task<Elements20SampleOutputs> Handler(Elements20SampleInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<Elements20SampleInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<Elements20SampleInputs>();
                }
            }

            var l = new InvocationWrapper<Elements20SampleInputs,Elements20SampleOutputs> (store, Elements20Sample.Execute);
