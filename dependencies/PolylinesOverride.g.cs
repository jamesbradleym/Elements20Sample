...
{
	/// <summary>
	/// Override metadata for PolylinesOverride
	/// </summary>
	public partial class PolylinesOverride : IOverride
	{
        public static string Name = "Polylines";
	...
	public static class PolylinesOverrideExtensions
    {
		/// <summary>
        /// Apply Polylines edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Polylines Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<PolylinesOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, PolylinesIdentity, bool> identityMatch,
            Func<T, PolylinesOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Polylines Overrides to apply — typically `input.Overrides.Polylines`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<PolylinesOverride> overrideData,
            Func<T, PolylinesIdentity, bool> identityMatch,
            Func<T, PolylinesOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Polylines)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Polylines)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Polylines)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<PolylinesOverride> edits,
            IList<PolylinesOverrideAddition> additions,
            IList<PolylinesOverrideRemoval> removals,            Func<PolylinesOverrideAddition, T> createElement,
            Func<T, PolylinesIdentity, bool> identityMatch,
            Func<T, PolylinesOverride, T> modifyElement,
