...
{
	/// <summary>
	/// Override metadata for LinesOverride
	/// </summary>
	public partial class LinesOverride : IOverride
	{
        public static string Name = "Lines";
	...
	public static class LinesOverrideExtensions
    {
		/// <summary>
        /// Apply Lines edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Lines Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<LinesOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, LinesIdentity, bool> identityMatch,
            Func<T, LinesOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Lines Overrides to apply — typically `input.Overrides.Lines`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<LinesOverride> overrideData,
            Func<T, LinesIdentity, bool> identityMatch,
            Func<T, LinesOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Lines)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Lines)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Lines)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<LinesOverride> edits,
            IList<LinesOverrideAddition> additions,
            IList<LinesOverrideRemoval> removals,            Func<LinesOverrideAddition, T> createElement,
            Func<T, LinesIdentity, bool> identityMatch,
            Func<T, LinesOverride, T> modifyElement,
